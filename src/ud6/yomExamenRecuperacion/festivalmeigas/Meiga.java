package ud6.yomExamenRecuperacion.festivalmeigas;
...
public class Meiga implements Comparable<Meiga> {
    ...
    public String toString() {
        String str1 = nome + " (" + alcume + ")";

        Comparator<Feitizo> compFei = new Comparator<Feitizo>() {

            @Override
            public int compare(Feitizo o1, Feitizo o2) {
                int res; 

                res = o2.getDificultade() - o1.getDificultade();
        ...
        feitizos.sort(compFei);

        String str2 = "Feitizos: " + feitizos;

        Map<String, Integer> mapaOrdenado = new TreeMap<>();
        mapaOrdenado.putAll(inventario);

        String str3 = "Inventario: " + mapaOrdenado;
