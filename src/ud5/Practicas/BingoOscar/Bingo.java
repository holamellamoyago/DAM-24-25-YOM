package ud5.Practicas.BingoOscar;
...
public class Bingo {
    ...
    public static void revisarCartonJugadores() {
        ...
        for (Jugador jugador : jugadores) {
            for (Carton carton : jugador.cartones) {
                switch (carton.revisarCarton(numerosSorteados)) {
                    case 0:
                        break;
                    case 1: // ( Linea (La cantamossi no se ha cantado turno anterior))
                        if (!linea) {
                            System.out.println(jugador.nombre + " canta linea con este carton: ");
                    ...
                    case 2: // Bingo
                        if (!linea) {
                            System.out.println(jugador.nombre + " canta BINGO!! con este carton: ");
                            System.out.println(carton);
                            nuevoBingo = true;
                        }
