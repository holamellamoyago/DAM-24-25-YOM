...
public class Casa extends Inmueble {
    public Casa(String nombre, int metros2, int habitaciones, int baños, int planta, int metrosTerreno) {
        super(nombre, metros2, habitaciones, baños, planta, metrosTerreno);
    }

    public Casa(String nombre, int metros2, int habitaciones, int baños, int planta) {
        super(nombre, metros2, habitaciones, baños, planta);
    }

    @Override
    public String detalle() {
        String linea1 = "Casa en " + nombre + ".\n" + metros2 + " m2, " + habitaciones + " hab, " + baños + " baños, "
                + planta + "ª planta";
