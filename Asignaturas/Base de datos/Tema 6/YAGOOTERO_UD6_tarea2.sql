...
--SELECT IDENT_CURRENT('HORASEXTRAS')
...
-- 2.
INSERT INTO CURSO (Nome, Horas) VALUES ('Dise�o web', 30)

DECLARE @CODIGOCURSO INT
SELECT @CODIGOCURSO = CODIGO
FROM CURSO
WHERE Nome='Dise�o web'

DECLARE @NOMBREPROFESORTECNICO VARCHAR
SELECT @NOMBREPROFESORTECNICO = E.NOME 
FROM DEPARTAMENTO D 
INNER JOIN EMPREGADO E ON D.NSSDirector = E.NSS --@@IDENTITY
...
--	WHERE NSS != NSSDirector AND D.NomeDepartamento = 'T�CNICO'
--))
...
FROM EMPREGADO E 
INNER JOIN DEPARTAMENTO D ON E.NumDepartamentoPertenece = D.NumDepartamento
WHERE E.NSS != @NOMBREPROFESORTECNICO AND D.NomeDepartamento ='T�CNICO'
...
VALUES (13,'DESE�O DE NOVA WEB', 'VIGO', @NUMDEPARTAMENTOTECNICO)

INSERT INTO TAREFA
VALUES (13,1, 'OBJETIVO DE LA PAGINA', DATEADD(DD,15, GETDATE()), DATEADD(DD, 22, GETDATE()), 'MEDIO', NULL),
(13,1, 'Elexir o estilo e crear o mapa do sitio', DATEADD(DD,20, GETDATE()), NULL, 'MEDIO', NULL)
