...
CREATE TABLE PROFESORES(
	...
	FEHAINICIOINVESTIGACION DATETIME DEFAULT GETDATE(),
	FECHAFININVESTIGACION DATETIME DEFAULT NULL,
	GRUPO INT,
	HOMBRE BINARY NOT NULL,
	NUMHIJOS SMALLINT DEFAULT 0,
	ESTADOCIVIL VARCHAR,
	SUPLEMENTO AS (NUMHIJOS * 100),
	AÑOSDEINVESTIGACION AS 
		(DATEDIFF(
			DAY, FEHAINICIOINVESTIGACION, FEHAINICIOINVESTIGACION)),
			
	USUARIO AS USER,
	
	CONSTRAINT PK_PROFESORES PRIMARY KEY(DNI),
	
	CONSTRAINT UNIQUE_GRUPOS UNIQUE (GRUPO),
